...
module.exports = function(environment) {
  var ENV = {
    ...
    APP: {
      ...
      //apiServer: "http://192.168.1.14:4500",
  ...
  ENV.contentSecurityPolicy = {
    'default-src': "'none'",
    'script-src': "'self' http://192.168.1.14:4500/ http://localhost:4500/ 'unsafe-eval' 'unsafe-inline' :49152 http://ermes.dlsi.uji.es:6080/arcgis/rest/services/ http://js.arcgis.com/ https://js.arcgis.com/",
    'font-src': "'self'",
    'connect-src': "'self' http://192.168.1.14:4500/ http://localhost:4500/ http://geo4.dlsi.uji.es:8080/ http://ermes.dlsi.uji.es:6080/arcgis/rest/ http://ermes.dlsi.uji.es:6686 http://ermes.dlsi.uji.es:6585/ http://server.arcgisonline.com/arcgis/rest/services/ http://services.arcgisonline.com/ http://www.arcgis.com/ http://static.arcgis.com/",
