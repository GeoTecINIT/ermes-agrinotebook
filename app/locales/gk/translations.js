export default {
  ...
  'panel': {
    ...
    'notification': {
      ...
      'user-exits': "Συγνώμη, το όναμα χρήστη ππου έχεται επιλέξει υπάρχει ήδη",
      ...
      'offline-parcels': "Συγνώμη, πρέπει να συνδεθείτε στο διαδύκτιο για να προσθέστε ή να αφαιρέσετε αγροτεμάχια",
      'offline-profile-update': "Συγνώμη, δεν μπορείτε να ενημερώσετε το προφίλ σας ενώ είστε εκτός σύνδεσης",
      'no-data-offline': "Φαίνετε να έχει χαθεί η σύνδεση σας και δεν έχουμε αποθυκεύση πληροφορίες για εσάς σε αυτήν την συσκευή",
      'try-again': "Τώρα μπορείτε να πρασπαθήστε να",
      'reconnect': "Επανασύνδεση",
      'retrieving-info': "Κάνουμε ανάκτηση του προφίλ σας απο τους διακομιστές μας. Παρακαλώ περιμένετε...",
      'first-login': "Παρακαλώ επιλέξτε τα αγροτεμάχια σς πατώντας πάνω τους, και πατήστε το κουμπί αποδοχής στην κάτω δεξιά γωνία όταν τελειώσετε",
      'got-it': "Το κατάλαβα",
      'saved': "Αποθυκεύτηκε"
    }
  },
