export default {
  ...
  'download-assets':{
    'download-basemap': "Λήψη δεδομένων για περιήγηση χωρίς σύνδεση (+/- 50MB)?",
    'download-advantages': "Συνιστάτε η λήψη δεδομένων για τη χρήση του χάρτη εκτός σύνδεσης και τη βελτίωση των επιδόσεων.",
